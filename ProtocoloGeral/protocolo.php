<?php
	...
	if (isset($_POST['submit']))
	{
		...
		$result = mysqli_query($conexao, "INSERT INTO protocolo (id_protocolo,data, hora, documento, interessado,cargo,orgao,encaminhamento,resumo,obs,saj,anexo,protocolista,emailinteressado ) VALUES (null,'{$data}','{$hora}','{$documento}','{$interessado}','{$cargo}','{$orgao}','{$encaminhamento}','{$resumo}','{$obs}','{$saj}','{$anexo}','{$protocolista}','{$emailinteressado}')");		
			...
			<div class="py-3 text-left">
				<form class="needs-validation" novalidate action="protocolo.php" method="POST" enctype="multipart/form-data" >
					...
					<div class="form-group">
							...
							<textarea type="text" class="form-control" id="obs" name="obs" rows="1" value= ""> </textarea>
						</div>
						...
						<div class="row">
							<div class="col-md-4 mb-3">
								...
								<input type="text" class="form-control" name="saj" id="saj" value=" ">
							</div>
